...
namespace DI_Service_Lifetime.Controllers
{
	...
	{
		private readonly IScopedGuidService _scoped1;               //Cykl ¿ycia obiektów w DI: Zale¿noœci mog¹ mieæ ró¿ne cykle ¿ycia:

																		//Singleton: Tworzona raz i wspó³dzielona przez ca³y czas dzia³ania aplikacji.
		...
		public IActionResult Index()
		{
			...
			return Ok(messages.ToString());                                         //Ok() to metoda pomocnicza (helper method) w ASP.NET Core, która tworzy odpowiedŸ HTTP o statusie 200 OK. Jest to standardowy kod statusu HTTP, który oznacza, ¿e ¿¹danie zosta³o przetworzone pomyœlnie.
		}
